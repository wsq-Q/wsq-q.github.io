...
### 1、每次重启电脑或者每天都会重定向到网络认证页面http://1.1.1.3/ac_portal/disclaimer/pc.html?![image-20240626094042221](../static/imgs/上网认证/image-20240626094042221.png)
...
### 4、安装pyinstaller库，打包成exe程序，生产auth_net.exe

```
pip install pyinstaller
pyinstaller -F aaaa.py
#生成dist/aaaa.exe
```

首次运行需要输入用户名密码进行认证，因此需要手动打开程序输入

后续脚本将账户信息保存到配置文件不需要再认证（除非删除Windows临时目录内的配置文件C:\Users\wsq\AppData\Local\Temp\user_account.json）

### 5、创建Windows任务计划程序

![image-20240626094621278](../static/imgs/上网认证/image-20240626094621278.png)

![image-20240626095237396](../static/imgs/上网认证/image-20240626095237396.png)

### 6、程序运行结果，每次开机自启动

![image-20240626094514131](../static/imgs/上网认证/image-20240626094514131.png)
